...
GAME_MESSAGE = "⩹━★⊷━⌞ 𝗦𝗢𝗨𝗥𝗖𝗘 • 𝗥𝗨𝗡𝗧𝗛𝗢𝗡⌝━⊶★━⩺\n\n★¦ مرحبا بك عزيزي:\n★¦في قسم العاب سبارك\n\n⩹━★⊷━⌞ 𝗦𝗢𝗨𝗥𝗖𝗘 • 𝗥𝗨𝗡𝗧𝗛𝗢𝗡⌝━⊶★━⩺"
GAME_BUTTONS = [
    [ 
        InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
        InlineKeyboardButton ('سبارك سبارك', callback_data= 'GAME2'),
        ],[
        InlineKeyboardButton ('⌞ 𝗦𝗢𝗨𝗥𝗖𝗘 • 𝗥𝗨𝗡𝗧𝗛𝗢𝗡⌝⚡️', url =f"https://t.me/xLxLxLrr3")              
                 ],[
